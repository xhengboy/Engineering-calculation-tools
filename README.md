...
Rate: 相機掃描頻率 (Hz)、Period: 掃描週期 (μs)、Round: 真圓度係數 (用於修正掃描時間)、Res: 影像精度 (每一像素代表的實際長度)
...
Res: 總解析度 (pixels)、Pix: 像素尺寸 (μm)、S: 感測器尺寸 (mm)
...
FOV: 視場範圍 (mm)、Res: 總解析度 (pixels)、Prec: 影像精度 (mm/pixel)
...
FOV: 視場範圍 (mm)、WD: 工作距離 (mm)、SS: 感測器尺寸 (mm)、f: 鏡頭焦距 (mm)
...
SS: 感測器尺寸 (mm)、m: 鏡頭倍率、FOV: 視場範圍 (mm)、px: 像素尺寸 (μm)、prec: 精度 (μm/pixel)、res: 總解析度 (pixels)
